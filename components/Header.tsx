    ...
    <motion.header
      ...
      style={{
        backgroundImage: isScrolled
          ? `linear-gradient(rgba(255, 255, 255, 0.5), rgba(255, 255, 255, 0.95)), url('/art/ComfyUI_00234_.png')`
          : `linear-gradient(rgba(255, 255, 255, 0.5), rgba(255, 255, 255, 0.9)), url('/art/ComfyUI_00234_.png')`,
