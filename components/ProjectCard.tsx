      ...
      <div className="card-professional hover:shadow-xl transition-all duration-300 w-full">
        ...
        <div className="p-4 space-y-4">
          ...
          <div className="space-y-3">
            {/* Title */}
            <h3 className="font-bold text-gray-900 text-lg md:text-xl line-clamp-2">
              {displayName}
            </h3>

            {/* Badges row */}
            <div className="flex flex-wrap gap-2">
              <span className="inline-flex items-center px-2 py-1 text-xs font-medium bg-gradient-to-r from-blue-100 to-blue-200 text-blue-800 rounded-full">
                {displayLanguage}
              </span>
              <span className="inline-flex items-center px-2 py-1 text-xs font-medium bg-gradient-to-r from-green-100 to-green-200 text-green-800 rounded-full">
                {displayCategory}
              </span>
            </div>
          </div>
          ...
          <div className="flex items-center justify-between pt-2 border-t border-gray-100">
            ...
            <a
              ...
              className="btn-professional text-sm px-3 py-1.5 inline-flex items-center flex-shrink-0 ml-2"
            >
